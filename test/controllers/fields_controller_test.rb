...
class FieldsControllerTest < ActionController::TestCase
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post :create, field: { active: @field.active, customer_id: @field.customer_id, name: @field.name, position: @field.position, type: @field.type }
    end
  ...
  test "should update field" do
    patch :update, id: @field, field: { active: @field.active, customer_id: @field.customer_id, name: @field.name, position: @field.position, type: @field.type }
    assert_redirected_to field_path(assigns(:field))
  end
